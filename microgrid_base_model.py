...
ID_MAP = {"buses": {}, "transformers": {}, "loads": {}, "sensors": {}, "fault_points": {}}
...
def create_base_network():
    ...
    # Explicitly set a smaller base MVA (e.g., 1000 kVA or 1 MVA) for stability
    ...
    # --- FAULT POINT 1: Primary Grid Input ---
    ID_MAP["fault_points"]["FAULT_GRID_120V"] = bus_grid
    ...
    # --- FAULT POINT 2: Residential Distribution ---
    ID_MAP["fault_points"]["FAULT_T1_48V"] = bus_t1_48v
    # --- FAULT POINT 3: Industrial Substation ---
    ID_MAP["fault_points"]["FAULT_SS1_24V"] = bus_ss1_24v
    ...
    for i in range(1, 7):
        ...
        # --- FAULT POINT 4: End User (Bus R1) ---
        if i == 1:
            ID_MAP["fault_points"]["FAULT_R1_12V"] = bus_idx
...
def save_id_map(id_map_data):
    ...
    # Iterate through the top-level keys (buses, transformers, loads, sensors, fault_points)
